...
import { useGetNotifications, useMarkAllSeen } from "../hooks/notification-query";
          ...
          {notificationsQuery.isLoading ? (
            ...
            notifications.map((notification) => (
              <Link
                ...
                href="#"
                className="flex items-start gap-3 px-4 py-3 hover:bg-accent transition-colors cursor-pointer"
              >
